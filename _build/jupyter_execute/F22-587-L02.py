...
# <b>Important:</b> When using fractional conversion as a stoichiometric variable, we do not define a new fractional conversion for each species.  This defeats the purpose of the exercise.  We want to use a single fractional conversion for a single reactant to quantify the changes in each species.
# </div>
