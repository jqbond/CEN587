...
# 2. Lectures: Link 105, MWF, 9:30AM - 10:25AM
# 3. Recitation: Link 369, Th, 5:00PM - 6:00PM
# 4. Exams vs. Projects?
#     * Projects!
# 5. Cancellations and Makeups (TBD)
# 6. Software for this course 
#     * Excel 
#     * Python 3 
#     * Jupyter Notebooks 
#     * Python 3, Jupyter, and most necessary packages bundled in Anaconda installation
#     * Anaconda available in ECS computer labs and through Apps Anywhere.
# 7. Textbook: Rawlings and Ekerdt, 2nd edition
# 8. Python Supplements on Blackboard
# 9. Use Piazza (instead of email) for posting questions 
# 10. This will be a project-based course; grading scale TBD.
...
# <span style="font-family:Times New Roman; font-size:1.5em;">**Intro to Chemical Reaction Engineering**</span>
# 
...
# 
# 
# * In general, our goal to design a reactor to accomplish a number of things: maximize yield of product in a safe and environmentally benign process with minimum capital and operating expense.; reaction occurs quickly; reaction occurs safely; with minimum energy input.
# 
# 
# * You've been studying chemical reactions for years: They all have intrinsic properties that determine how I will need to design my reactor. Absorb or release energy; happen at different rates and on different time scales; produce toxic or low-value byproducts; thermodynamically limited (reversible);. All of these characteristics effect how we design the reactor to achieve our stated goals.
# 
# 
# * Chemical Reactors also have unique properties. How well are they mixed? Do they have temperature or composition gradients? Are they closed systems (no mass transfer across boundary) or open systems (mass transfer by flow across boundary).  Are they flow processes or batch processes? Do they perform ideally, or are they "real" reactors?
# 
# 
...
# $$
# 
# And we can define a species vector as:
# 
# $$
...
# 
# We also define a vector of species containing all species $j$ = 1 to 8:
# 
# $$
