...
# 
# $$K = K_0\exp\left[\frac{-(\Delta H_R - \Delta C_p T_R)}{R} \left(\frac{1}{T} - \frac{1}{T_0}\right) + \Delta C_p \ln\left(\frac{T}{T_0}\right)\right] \label{eq6}\tag{6}$$
# 
...
# 
# $$K_1(T) = K_{1_0}\exp\left[\frac{-(\Delta H_{1_R} - \Delta C_{p_1} T_R)}{R} \left(\frac{1}{T} - \frac{1}{T_0}\right) + \Delta C_{p_1} \ln\left(\frac{T}{T_0}\right)\right] \label{eq7}\tag{7}$$
# 
# $$K_2(T) = K_{2_0}\exp\left[\frac{-(\Delta H_{2_R} - \Delta C_{p_2} T_R)}{R} \left(\frac{1}{T} - \frac{1}{T_0}\right) + \Delta C_{p_2} \ln\left(\frac{T}{T_0}\right)\right] \label{eq8}\tag{8}$$
# 
...
# 
# $$K_1(T) = K_{1_0}\exp\left[\frac{-(\Delta H_{1_R} - \Delta C_{p_1} T_R)}{R} \left(\frac{1}{T} - \frac{1}{T_0}\right) + \Delta C_{p_1} \ln\left(\frac{T}{T_0}\right)\right]$$
# 
# $$K_2(T) = K_{2_0}\exp\left[\frac{-(\Delta H_{2_R} - \Delta C_{p_2} T_R)}{R} \left(\frac{1}{T} - \frac{1}{T_0}\right) + \Delta C_{p_2} \ln\left(\frac{T}{T_0}\right)\right]$$
# 
