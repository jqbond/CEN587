...
# 
# Note that those are both saturation pressures.  Saturation pressures are only a function of temperature, and both the system state (numerator) and the reference state (denominator) are specified at the reaction temperature; accordingly, the two saturation pressures in Equation (\ref{eq22}) are equal.
# 
